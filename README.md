...
| **한종민** (`jongmin3`, `jongmin1111111111`) | - 코인아이템 스크립트, 프리펩<br>- 게임오버시 나올 패널, 게임오버로직<br>- 스코어매니저 스크립트
| **이원혁** (`lwh`)                    | - 
| **정지원** (`JJW_UI`)                 | - 타이틀씬, -플레이어 애니메이션, -사운드, -필요 에셋 제작, -인게임 외 UI
| **전체 팀**                         | - 게임 기획, 버그 수정, 테스트 및 피드백 공유 등 협업 전반 |
